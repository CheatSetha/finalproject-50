...
export default function Page() {
  ...
  return (
    <div className="bg-[whitesmoke] h-screen flex justify-center items-center">
      <div className="w-[90%] h-fit lg:w-[600px] mx-auto shadow-md rounded-[16px] p-5 dark:bg-slate-800 bg-white">
