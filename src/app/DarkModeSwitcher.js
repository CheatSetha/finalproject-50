...
export const DarkModeSwitcher = () => {
  ...
  return (
    <div className="dropdown ">
      ...
      <div className="dropdown-menu dark:bg-slate-950 dark:text-white  mt-2 w-32 rounded-lg z-50">
        <span
          tabIndex={-1}
          className={clsx(
            theme === "light" && "dropdown-active",
            "dropdown-item flex-row gap-2 text-sm dark:hover:text-black "
          )}
        ...
        <span
          ...
          className={clsx(
            ...
            "dropdown-item flex-row gap-2 text-sm text-black  dark:hover:text-black dark:active:text-black"
          )}
        ...
        <span
          ...
          className={clsx(
            ...
            "dropdown-item flex-row gap-2 text-sm  dark:hover:text-black dark:active:text-black"
          )}
