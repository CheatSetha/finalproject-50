...
export default function page() {
  ...
  return (
    <div className="w-full p-5 mx-auto db-bg h-full lg:h-screen dark:bg-primary">
      <div className="db-bg dark:bg-primary sticky top-20 z-30">
        <h1
          className={
	  ...
	  <h1 className="text-start text-3xl font-semibold text-black mt-10 dark:text-white">Search Engine Optimization Configuration</h1>
            ...
            <div className="grid grid-cols-1 mt-10 md:grid-cols-2 gap-5">
              <div className=" w-full">
                ...
                <Field
                  ...
                  placeholder="watermark , technology , photo editor"
                />
                <ErrorMessage
                  name="keyword"
                  component="h1"
