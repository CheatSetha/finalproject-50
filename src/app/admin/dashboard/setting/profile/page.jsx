      ...
      <section className="h-full p-5">
        ...
        >
          {({ isSubmitting, setFieldValue, values }) => (
            <Form className="">
              <div className="grid gap-x-10 gap-5 md:grid-cols-2 w-full ">
                {/* user name */}
                <div className="mb-3">
                  <label
                    htmlFor="username"
                ...
                <div className=" mb-6 w-full ">
                  ...
                  />
                  {
                    preview ? <>
                      <div>
                        <img
                          className="mt-4 rounded-main w-44 h-44"
                          src={`https://photostad-api.istad.co/files/${preview}`} alt={values.image} />
                      </div>
                    </> : <div >
                      <img
                        className="mt-4 rounded-main w-44 h-44"
                        src={`https://photostad-api.istad.co/files/no-photo.jpg`} alt={values.image}/>
