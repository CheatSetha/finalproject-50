  ...
  return (
    <div className='w-[90%] mx-auto rounded-[16px] dark:bg-[#1e1e1e]  bg-white p-5'>
      ...
      >
        <Form>
          <div class='my-6'>
            <label for='phoneNumber'  className="block mb-2 text-sm      text-gray-500 dark:text-white">
              Phone Number
            </label>
            <Field
              type='text'
          ...
          <div class='mb-6'>
            <label for='dob'  className="block mb-2 text-sm      text-gray-500 dark:text-white">
              Date of Birth
            </label>
            <Field
              type='date'
          ...
          <label for='address'  className="block mb-2 text-sm      text-gray-500 dark:text-white">
            Address
          </label>
          <Field
            as='textarea'
            id='address'
            name='address'
                className=' rounded-main border-none bg-[whitesmoke] mb-3 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 w-full h-[45px]'
          />
