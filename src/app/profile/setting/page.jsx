...
import ButtonRed from "@/components/util/ButtonRed";
...
export default function Page() {
  ...
  return (
    <div className="w-[90%] mx-auto bg-white dark:bg-[#1e1e1e]  p-5 rounded-[16px]">
      ...
      <p className="font-extralight w-full md:w-[550px] mb-5">
      ...
      >
        {({ isSubmitting, setFieldValue, values }) => (
          <Form className="w-full md:w-[550px]">
            ...
            <Field
              className="file-input  rounded-main w-full bg-[whitesmoke] dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            ...
            {preview ? (
              <>
                <div>
                  <img
                    ...
                    className="mt-4 w-56 h-56 rounded-main object-cover"
              ...
              <div>
                <img
                  className="mt-4 rounded-main w-56 h-56 object-cover"
...
<h2 className="my-6  dark:text-white font-semibold">
            ...
            <div className="flex justify-between gap-3 max-sm:flex-col flex-wrap mt-5">
              <div className="mb-6 w-[45%]">
                ...
                <Field
                  ...
                  className=" rounded-main ps-3 border-none bg-[whitesmoke] dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 w-full h-[45px]"
                />
              </div>
              <div className="mb-6 w-[45%]">
                <label
            ...
            <div className="mb-6">
              ...
              <Field
                ...
                name="gender"
                value={values.gender}
                className=" rounded-main border-none bg-[whitesmoke] dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 w-full h-[45px]"
              >
            ...
            <div className="mb-2">
              <label className="block mb-2 text-sm      text-gray-500 dark:text-white">
                Bio
              </label>
              <Field
                as="textarea"
                name="biography"
                className=" rounded-main border-none  bg-[whitesmoke] dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 w-full h-[200px] "
              />
            </div>

            {/* <button
              type="submit"
              className="text-[17px] h-12 mt-6 bg-red rounded-main text-white p-2.5 px-4 btn font-light"
            >
              Save Changes
            </button> */}
            <CustomBtn />
