  ...
  const submitHandler = async (values) => {
    ...
    try {
      ...
      for (var i = 0; i < error?.data?.errors.length; i++) {
        ...
        setTimeout(() => {
          // alert("bong setha") first error go here
          toast.error(errorMessage, {
            position: "top-right",
            autoClose: 2000,
            hideProgressBar: false,
                ...
                <Form>
                  <div className="grid gap-x-10 gap-6 mb-3 md:grid-cols-2 w-full ">
                    ...
                    <div className=" mb-6 w-full ">
                      <label htmlFor="file"  className="block mb-2 text-sm      text-gray-500 dark:text-white">
                        Profile
                      </label>
                      <Field
                        type="file"
...
function CustomInput({ field, form, isSubmitting, ...props }) {
  ...
  return (
    <div>
      ...
      />
      {preview ? (
        <div className="w-60 h-60 rounded-[16px] mt-5">
